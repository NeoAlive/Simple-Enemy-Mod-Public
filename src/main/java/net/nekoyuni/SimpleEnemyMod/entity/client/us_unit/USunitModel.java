...
public class USunitModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public USunitModel(ModelPart root) {
        ...
        this.unit = this.fakeRoot.getChild("unit"); //Modificado para el nuevo root
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (unitEntity.hurtAnimationState.isStarted()) {
            ...
            this.animate(unitEntity.hurtAnimationState,
                    ...
                    ageInTicks, 2.0f);  // ← Usar speed del manager
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        fakeRoot.render(poseStack, vertexConsumer, packedLight, packedOverlay, color); //modificado
